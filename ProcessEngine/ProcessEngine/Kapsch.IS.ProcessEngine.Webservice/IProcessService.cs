...
namespace Kapsch.IS.ProcessEngine.Webservice
{
    ...
    public interface IProcessService
    {
        ...
        [FaultContract(typeof(FcDefaultException))]
        ...
        [OperationContract]
        WorkflowInstanceItem CreateWorkflowInstance(WorkflowMessageDataItem workflowMessageDataItem);
        ...
        [OperationContract]
        List<WorkflowInstanceStatusItem> GetStatusList(List<string> woins);

        [OperationContract]
        WorkflowInstanceStatusItem SetWorkflowInstanceStatus(WorkflowInstanceStatusItem worfklowInstanceStatus);

        [OperationContract]
        void DoCallback(string workflowInstanceID, string clientReferenceID, string callbackResult, string callBackStatus);

        [OperationContract]
        List<ActivityResultMessageItem> GetActivityResultMessagesForWorkflowInstance(string workflowInstanceID);

        [OperationContract]
        string KMPMonitoring();
    }
}
