...
namespace Kapsch.IS.EMD.EMD20Web.Models.Shared
{
    public class SelectionAddModel
    {
        ...
        public string JavaScriptSelectedEvent { get; internal set; }
        //public string ReferencePropertyName { get; internal set; }

        [Obsolete("not needed if you set the SelectionAddModel to a property.new() in the default constructor")]
